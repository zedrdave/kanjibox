...
{	
	...
	if(@$params['action'] == 'publish_story' && fb_connect_init() && @$params['publish_type']) {
...
?>
<fieldset class="stats"><legend><?php echo $type_label . ' ' . $levels[$_SESSION['user']->get_level()]; ?> Level High Scores</legend>
	<table class="twocols"><tr><td>
<?php
...
?>
 ...
 <fieldset class="stats"><legend>Other Levels</legend>
	<table class="twocols">
	<tr><td>
<?php
