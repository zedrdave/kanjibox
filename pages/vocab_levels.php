...
<form><input type="submit" name="search" value="Search" /> <input type="text" size="20" name="contains" value="<?php
                                                                  echo htmlentities($_REQUEST['contains'], ENT_COMPAT,
                                                                      'UTF-8')
                                                                  ?>"></input> (<input type="checkbox" name="exact_match" <?php if ($_REQUEST['exact_match']) echo 'checked="yes"';?>/> exact match)</form>
    <?php
