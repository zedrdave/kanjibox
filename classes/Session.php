...
class Session {
    ...
    function display_quiz_header() {
        ...
        <table id="quiz-header" class="twocols">
            <tr><td>
                    <div class="info">Level: <?php echo Session::$level_names[$this->session_level] ?> - Wave: <?php echo ($this->cur_wave + 1); ?> <a href="#" onclick="do_load('<?php echo SERVER_URL ?>ajax/stop_quiz/', 'session_frame');
    ...
    function is_quiz() {
        return ($this->session_mode == QUIZ_MODE);
    }

    function is_learning_set() {
        return ($this->session_mode == SETS_MODE);
    }

    function is_grammar_set() {
        return ($this->session_mode == GRAMMAR_SETS_MODE);
    }
    ...
    function get_set_id() {
        return $this->question_loader->set_id;
    }
    ...
    function get_nice_level() {
        return Session::$level_names[$this->session_level];
    }
    ...
    function get_cur_wave() {
        return $this->cur_wave;
    }

    function get_cur_grade() {
        return $this->wave_grade;
    }

    //Debug
    function set_cur_wave($_cur_wave) {
        $this->cur_wave = $_cur_wave;
    }
