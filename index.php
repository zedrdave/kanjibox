...
if(!@$pages[$page] && !@$secret_pages[$page])
	$page = 'main';

$logged_in = init_app();


if(@$_SESSION && @$_SESSION['crawler'])
	$page = 'faq';
...
if(@$params['redirect'] == 'back_to_forum' || @$_REQUEST['redirect'] == 'back_to_forum') {
	header('Location: http://kanjibox.net/forum/');
	exit();
}
if(@$params['redirect'] == 'set_subscribe' || @$_REQUEST['redirect'] == 'set_subscribe') {
...
if(isset($_REQUEST['save_prefs']) && @$_SESSION['user'])
