...
<fieldset class="section" id="sentences">
    ...
    <form class="ajax-form" action="<?php echo SERVER_URL;?>ajax/get_sentence/" method="post">
        ...
        <p style="text-align: right"><a id="create-sentence-button" href="#" onclick="$('#create-sentence').show();
                $(this).hide();
                return false;">[create new sentence]</a></p>
    </form>
    <div id="create-sentence" style="display:none;">
        <hr/>
        <form class="ajax-form" action="<?php echo SERVER_URL;?>ajax/edit_sentence/" method="post">
            <p>Jp: <input type="text" name="example_str" id="example_str" style="width:90%;"/></p>
            <p>En: <input type="text" name="english" id="example_str" style="width:90%;"/></p>
    ...
    $(document).ready(function()
    {
        $('#sentences > .ajax-form').ajaxForm({
            ...
            beforeSubmit: function() {
                $('#sentences > .ajax-result').html('Loading...')
            },
        });
